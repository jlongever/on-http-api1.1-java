...
public class GetApi {
  ...
  public List<Catalog> catalogsGet(String query) throws ApiException {
    ...
    GenericType<List<Catalog>> localVarReturnType = new GenericType<List<Catalog>>() {};
   ...
   * @throws ApiException if fails to make API call
   */
  public Object profilesLibraryGet() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/profiles/library".replaceAll("\\{format\\}","json");
   ...
   * @throws ApiException if fails to make API call
   */
  public Object profilesLibraryIdentifierGet(String identifier) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public Object skusGet() throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public Object skusIdentifierGet(String identifier) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'identifier' is set
    if (identifier == null) {
      throw new ApiException(400, "Missing the required parameter 'identifier' when calling skusIdentifierGet");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public Object versionsGet() throws ApiException {
    Object localVarPostBody = null;
    
    // create path and map variables
    String localVarPath = "/versions".replaceAll("\\{format\\}","json");
